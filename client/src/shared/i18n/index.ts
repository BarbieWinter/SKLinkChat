...
const translations: Record<AppLanguage, Record<TranslationKey, string>> = {
  'zh-CN': {
    ...
    'chat.connectionHint': '可在设置中调整性别标识和话题偏好。',
    ...
    'settings.title': '个人设置',
    'settings.description': '用户名在注册后固定，这里只调整性别标识和话题偏好。',
    'settings.namePlaceholder': '用户名在注册后固定',
    ...
    'welcome.subtitle': '注册一个唯一用户名后即可开始聊天。',
    'welcome.namePlaceholder': '输入唯一用户名',
